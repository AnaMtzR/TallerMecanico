    ...
    <table align="center" width="auto">
        <tr>
            <td width="400px">
                ...
                {!! Form::date('fecha_inicio', null, ['placeholder' => 'Ingresa nombre del tipo', 'class' =>
                'form-control']) !!}

                {!! Form::label('id_servicio', 'Servicio a cotizar') !!}
                {!! Form::select('id_servicio', $servicios->pluck('nombre', 'id')->all(), null, ['placeholder' =>
                'Seleccionar ...', 'class' => 'form-control']) !!}
                {!! Form::label('status', 'Estatus') !!}
                {!! Form::select('status', ['1' => 'Activo', '0' => 'Baja'], '1', ['placeholder' => 'Selecciona estatus del
            ...
            <td width="200px" height="310px">
                ...
                {!! Form::textarea('descripcion', null, ['placeholder' => 'Ingresa la descripcion del servicio', 'class' =>
                'form-control']) !!}
            </td>
        </tr>
    </table>
